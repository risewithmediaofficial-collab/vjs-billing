              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="text-gray-450 text-xs truncate">{product.barcode || (product._id || product.id)} • {product.category}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  {isAdminOrManager && isExpanded && (
                    <div className="flex gap-1.5 animate-fade-in" onClick={e => e.stopPropagation()}>
                      ...
                      <button onClick={() => handleDelete(product._id || product.id)} className="w-7 h-7 rounded-lg bg-red-50 hover:bg-red-100 text-red-500 hover:text-red-700 flex items-center justify-center transition-all border border-red-200">
                        <Trash2 size={12} />
                      </button>
                    </div>
                  )}
