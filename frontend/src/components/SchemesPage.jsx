    ...
    <div className="space-y-6 animate-fade-in text-gray-800">
            ...
            <div key={scheme._id} className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm space-y-4 hover:shadow-md transition-all">
              <div className="flex justify-between items-start">
                ...
                <span className={`text-xs px-2.5 py-1 rounded-full font-bold uppercase tracking-wider ${
                  ...
                  scheme.status === 'completed' ? 'bg-gray-100 text-gray-500' :
      ...
      {showEnrollModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <form onSubmit={handleEnrollSubmit} className="w-full max-w-lg bg-white border border-gray-200 rounded-2xl p-6 shadow-2xl animate-fade-in text-gray-800">
