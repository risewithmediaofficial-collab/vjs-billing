...
const initialStaff = [
  { name: 'Rajesh Kumar',  role: 'Senior Staff', pin: '1234', storeId: 'store-1' },
  { name: 'Priya Sharma',  role: 'Staff',         pin: '5678', storeId: 'store-1' },
  { name: 'Anil Verma',    role: 'Manager',       pin: '9012', storeId: 'store-2' },
  { name: 'Sunita Devi',   role: 'Staff',         pin: '3456', storeId: 'store-2' },
...
async function seed() {
  ...
  try {
    ...
    console.log('  Admin    → name: "System Admin" | PIN: 0000');
    console.log('  Manager  → name: "Anil Verma"   | PIN: 9012');
    console.log('  Staff    → name: "Rajesh Kumar"  | PIN: 1234');
